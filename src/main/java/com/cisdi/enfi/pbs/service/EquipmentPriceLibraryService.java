 ...
 * <p> Company: </p>  
 * @author Proem_ds
 * @date 2017年3月1日 下午5:00:20
 */
public interface EquipmentPriceLibraryService {
	 ...
	 * @throws Exception
	 */
	public String buildMaterialCategoryIds(String rootId, boolean isRecursion)
			throws Exception;
...
//            List<EquipPrice_to_SupplierVo> epsVo, String userId)
//			throws Exception;
	 ...
	 * @throws Exception
	 */
//	public Map<String, Object> deleteEquipmentPriceLibrary(String id,
//                                                           String epSrc, String projectId, String pbsCode) throws Exception;
...
//            String pbsVersionId, String pbsNodeId, String projectId,
//            String dataSrc, String userId) throws Exception;
	/**
	 * 获取设备单价
	 * @param projMMId
	 * @return
