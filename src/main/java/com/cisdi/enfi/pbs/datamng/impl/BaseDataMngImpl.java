package com.cisdi.enfi.pbs.datamng.impl;

import com.cisdi.enfi.pbs.datamng.BaseDataMng;
import com.cisdi.enfi.pbs.model.Entity;
import com.cisdi.enfi.pbs.model.Root;
import com.cisdi.enfi.pbs.utils.UuidUtils;
...
public class BaseDataMngImpl extends BaseEntityMngImpl implements BaseDataMng {
    ...
    public <T extends Root> T getObjByCondition(String dbId, String className, String condition) {
        ...
        return list != null && list.size() > 0 ? (T) (Root) list.get(0) : null;
    }
